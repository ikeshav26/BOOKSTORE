    ...
    return (
        <>
            <div className='bg-base-100 max-w-screen shadow-sm mx-auto md:px-20 px-4'>
                ...
                <p>Discover our wide selection of free courses, thoughtfully designed to help you gain valuable skills, expand your knowledge, and achieve your personal or professional goals—no cost, no commitment.</p>
            </div>
